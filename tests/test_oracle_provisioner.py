...
def test_oracle_engine_init():
    engine = OracleEngine()
    assert engine.is_active is False
    assert len(engine.chat_history) == 0

def test_oracle_hook_functions():
