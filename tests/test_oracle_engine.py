...
def test_oracle_engine_system_prompt_v4():
    engine = OracleEngine()
...
def test_split_conformal_interval():
...
def test_validate_section_12_5_compliant():
...
def test_validate_section_12_5_non_compliant():
